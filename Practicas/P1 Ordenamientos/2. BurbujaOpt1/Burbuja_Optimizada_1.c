...
//Compilación: "gcc Burbuja_Optimizada_1.c tiempo.x  -o Burbuja_Optimizada_1" (tiempo.c si se tiene la implementación de la libreria o tiempo.o si solo se tiene el codigo objeto)
//Ejecución: "./Burbuja_Optimizada_1 n" (Linux y MAC OS)
//*****************************************************************
