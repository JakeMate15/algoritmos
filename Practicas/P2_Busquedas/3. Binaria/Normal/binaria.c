...
//Compilación: "gcc binaria.c tiempo.x  -o binaria" (tiempo.c si se tiene la implementación de la libreria o tiempo.o si solo se tiene el codigo objeto)
//Ejecución: "./binaria n" (Linux y MAC OS)
//*****************************************************************
